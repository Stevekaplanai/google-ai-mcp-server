...
exports.LyriaService = void 0;
const google_auth_library_1 = require("google-auth-library");
const base_service_js_1 = require("./base.service.js");
class LyriaService extends base_service_js_1.BaseGoogleService {
    projectId;
    location;
    auth;
    MAX_RETRIES = 3;
    ...
    async generateMusic(request) {
        ...
        try {
            ...
            this.log('Failed to generate music', { error: error.message });
            throw error;
        }
    }
    validateRequest(request) {
        ...
        const validStructures = ['verse-chorus', 'free-form', 'instrumental'];
    ...
    processApiResponse(result, request, modelName) {
...
exports.LyriaService = LyriaService;
//# sourceMappingURL=lyria.service.js.map