...
exports.ImagenTool = void 0;
const imagen_service_js_1 = require("../services/imagen.service.js");
class ImagenTool {
    service;
    constructor(apiKey, config) {
        this.service = new imagen_service_js_1.ImagenService(apiKey, config);
    }
    /**
    ...
    async handleGenerateImage(args) {
        try {
            ...
            // Call the service
            const response = await this.service.generateImage(params.prompt, params.aspectRatio, params.sampleCount, params.negativePrompt, params.personGeneration, params.language, params.outputStorageUri);
...
exports.ImagenTool = ImagenTool;
//# sourceMappingURL=imagen-tool.js.map